...
- [Introduction to DevOps](#introduction-to-devops)
  - [Course Introduction](#course-introduction)
    - [How to change a Culture](#how-to-change-a-culture)
  - [Business Case For DevOps](#business-case-for-devops)
  - [DevOps Adoption](#devops-adoption)
    - [Unlearn what you have Learned](#unlearn-what-you-have-learned)
    - [Consider this:](#consider-this)
    - [2016 DevOps Enterprise Summit](#2016-devops-enterprise-summit)
      - [How are they doing this?](#how-are-they-doing-this)
  - [Definition of DevOps](#definition-of-devops)
    - [DevOps defined:](#devops-defined)
    - [DevOps requires:](#devops-requires)
    - [What DevOps not:](#what-devops-not)
  - [Essential Characteristics of DevOps](#essential-characteristics-of-devops)
    - [What's the Goal?](#whats-the-goal)
    - [Agility: The Three pillars](#agility-the-three-pillars)
    - [The Perfect Combination/Storm](#the-perfect-combinationstorm)
    - [Learning how to work differently](#learning-how-to-work-differently)
    - [Application Evolution](#application-evolution)
    - [How to change a Culture?](#how-to-change-a-culture)
  - [Leading Up to DevOps](#leading-up-to-devops)
    - [Traditional Waterfall Method](#traditional-waterfall-method)
      - [Problems with Waterfall Approach](#problems-with-waterfall-approach)
  - [XP, Agile, and Beyond](#xp-agile-and-beyond)
    - [Extreme Programming (XP)](#extreme-programming-xp)
    - [The Agile Manifesto](#the-agile-manifesto)
    - [Agile Development](#agile-development)
    - [Shadow IT](#shadow-it)
  - [Brief History of DevOps](#brief-history-of-devops)
    - [Why is the history significant?](#why-is-the-history-significant)
...
![](assets/Pasted%20image%2020230509075438.png)
...
![](assets/Pasted%20image%2020230509080155.png)
...
![](assets/Pasted%20image%2020230509080913.png)
...
![](assets/Pasted%20image%2020230509081303.png)

**DevOps has three dimensions:**

![](assets/Pasted%20image%2020230509081426.png)
...
![](assets/Pasted%20image%2020230509081809.png)
...
![](assets/Pasted%20image%2020230509082531.png)
...
![](assets/Pasted%20image%2020230509084206.png)
...
![](assets/Pasted%20image%2020230509084310.png)

**Agile alone is not good enough:**

![](assets/Pasted%20image%2020230509084504.png)
...
![](assets/Pasted%20image%2020230509090146.png)
